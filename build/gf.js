...
(function (window) {
  define('math/Vector',['require', 'exports', 'module', '../utils/utils'], 
...
(function (window) {
  define('math/Rectangle',['require', 'exports', 'module', '../vendor/pixi'], 
  function (require, exports, module) {
  // uRequire: start body of original nodejs module
...
(function (window) {
  define('audio/AudioPlayer',['require', 'exports', 'module', './AudioPlayer', '../utils/EventEmitter', '../utils/utils', '../utils/support'], 
  function (require, exports, module) {
  // uRequire: start body of original nodejs module
var AudioPlayer = require("./AudioPlayer"), EventEmitter = require("../utils/EventEmitter"), utils = require("../utils/utils"), support = require("../utils/support");
...
(function (window) {
  define('audio/AudioManager',['require', 'exports', 'module', './AudioPlayer', '../utils/utils', '../utils/support'], 
  function (require, exports, module) {
  // uRequire: start body of original nodejs module
var AudioPlayer = require("./AudioPlayer"), utils = require("../utils/utils"), support = require("../utils/support");
...
(function (window) {
  define('display/DisplayObjectContainer',['require', 'exports', 'module', '../utils/EventEmitter', '../utils/utils', '../vendor/pixi'], 
  function (require, exports, module) {
  // uRequire: start body of original nodejs module
var EventEmitter = require("../utils/EventEmitter"), utils = require("../utils/utils"), PIXI = require("../vendor/pixi");
...
(function (window) {
  define('display/Sprite',['require', 'exports', 'module', '../utils/EventEmitter', '../utils/utils', '../vendor/pixi', '../constants'], 
  function (require, exports, module) {
  // uRequire: start body of original nodejs module
var EventEmitter = require("../utils/EventEmitter"), utils = require("../utils/utils"), PIXI = require("../vendor/pixi"), C = require("../constants");
...
(function (window) {
  define('font/BitmapFont',['require', 'exports', 'module', '../display/DisplayObjectContainer', '../display/Sprite', '../utils/ObjectPool', '../math/Rectangle', '../display/Texture', '../utils/utils', '../vendor/pixi'], 
  function (require, exports, module) {
  // uRequire: start body of original nodejs module
var DisplayObjectContainer = require("../display/DisplayObjectContainer"), Sprite = require("../display/Sprite"), ObjectPool = require("../utils/ObjectPool"), Rectangle = require("../math/Rectangle"), Texture = require("../display/Texture"), utils = require("../utils/utils"), PIXI = require("../vendor/pixi");
...
(function (window) {
  define('fx/camera/Close',['require', 'exports', 'module', './Effect', '../../utils/utils'], 
  function (require, exports, module) {
  // uRequire: start body of original nodejs module
var Effect = require("./Effect"), utils = require("../../utils/utils");
...
(function (window) {
  define('fx/camera/Fade',['require', 'exports', 'module', './Effect', '../../utils/utils'], 
  function (require, exports, module) {
  // uRequire: start body of original nodejs module
var Effect = require("./Effect"), utils = require("../../utils/utils");
...
(function (window) {
  define('fx/camera/Flash',['require', 'exports', 'module', './Effect', '../../utils/utils'], 
  function (require, exports, module) {
  // uRequire: start body of original nodejs module
var Effect = require("./Effect"), utils = require("../../utils/utils");
...
(function (window) {
  define('fx/camera/Scanlines',['require', 'exports', 'module', './Effect', '../../utils/utils', '../../constants'], 
  function (require, exports, module) {
  // uRequire: start body of original nodejs module
var Effect = require("./Effect"), utils = require("../../utils/utils"), C = require("../../constants");
...
utils.inherits(Shake, Effect, {
    ...
    update: function(dt) {
        ...
        if (this.duration <= 0) {
            ...
            if (this.direction === C.DIRECTION.BOTH || this.direction === C.DIRECTION.HORIZONTAL) this.offset.x = math.round(Math.random() * this.intensity * this.parent.size.x * 2 - this.intensity * this.parent.size.x);
            if (this.direction === C.DIRECTION.BOTH || this.direction === C.DIRECTION.VERTICAL) this.offset.y = math.round(Math.random() * this.intensity * this.parent.size.y * 2 - this.intensity * this.parent.size.y);
            this.parent.pan(this.offset.x, this.offset.y);
        }
    }
});
...
(function (window) {
  ...
  function (require, exports, module) {
  // uRequire: start body of original nodejs module
var utils = require("../utils/utils"), DisplayObjectContainer = require("../display/DisplayObjectContainer");
...
var PhysicsTarget = module.exports = function() {
    ...
    this.onCollision = function(obj, vec, colShape, myShape) {
        if (obj.type === Sprite.TYPE.COLLECTABLE) obj.destroy();
